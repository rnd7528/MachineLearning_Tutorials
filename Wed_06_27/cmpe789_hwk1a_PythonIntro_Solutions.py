...
#                              BEGIN YOUR CODE                                 #
################################################################################
linear = linear_model.LinearRegression()  #note this is not necessary
linear.fit(X_train, y_train)
...
# Note, if you get an error on the previous line, you need to update scikit-learn:
# From Anaconda command prompt, execute:
...
#=========================================================
# begin Task 2 Template  - SOLUTION
#
# Task 2: Use the following template to create a 3x2 subplot using the 
# dataset from above.
# The plots, from first to last are: 
...
classifiers = [
    ...
    SVC(kernel="rbf", C=0.025, gamma=0.1),
    RandomForestClassifier(max_depth=5, n_estimators=10, max_features=1),
    MLPClassifier(hidden_layer_sizes=(20,20),alpha=1)]
################################################################################
#                              END OF YOUR CODE                                #
################################################################################
...
# end of Task 2 Template - SOLUTION
#=========================================================

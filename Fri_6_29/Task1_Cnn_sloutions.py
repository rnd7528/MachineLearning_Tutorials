...
def getActivations(layer,stimuli,name,sess):
...
###### Fill in the Code #####
    ...
    # using the funtion 'create_new_conv_layer' which is defined above.
...
###### Fill in the Code #######
    # setup some weights and bias values for this dense layer, then activate with ReLU
...
# b. Change the selected test image number for visualization of different class.
 ...
 # tensorboard --logdir='./logs/cnn_tensorflow' --port= (4 digit number of your choice)
